  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center w-full h-full py-4 min-h-0 text-left">
      ...
      <div className="lg:col-span-7 flex flex-col justify-center">
        <div className="flex items-center gap-1.5 text-[9px] font-mono tracking-widest text-[#d4ff3a] uppercase mb-3 select-none">
        ...
        <h2 className="text-2xl sm:text-4.5xl font-sans font-black tracking-tight text-white mb-4 leading-none select-none">
          ...
          <span className="inline-block w-2.5 h-6 bg-lime-400 align-middle ml-1.5 shadow-[0_0_8px_#d4ff3a] animate-pulse" />
        </h2>

        <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed max-w-lg mb-6">
        ...
        <div className="flex select-none">
          <motion.a 
            ...
            whileTap={{ scale: 0.98 }}
            className="px-6 py-3 rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 text-black font-mono font-black text-[10px] uppercase tracking-widest flex items-center justify-between gap-4 shadow-[0_4px_15px_rgba(34,211,238,0.25)] group cursor-pointer"
          >
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex flex-col text-left">
                ...
                <a href="mailto:ceo@avro.co.kr" className="text-zinc-200 font-bold hover:text-lime-400 text-xs transition-colors">
                  ceo@avro.co.kr
                </a>
              </div>
            </div>
